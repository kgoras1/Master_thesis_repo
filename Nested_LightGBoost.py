...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 10 10:38:27 2024
...
with open('/Volumes/Seagate Expansion Drive/LSCC:LUAD:512NoBackroundFinal_Tiles/models/LightBoost_VGG16_Model.txt', 'rb') as file:
...
model_directory = '/Volumes/Seagate Expansion Drive/LSCC:LUAD:512NoBackroundFinal_Tiles/models/'
...
# Now save the model
model_filename = os.path.join(model_directory, 'LightBoost_VGG16_Model.txt')

# Access the Booster from the trained LGBMClassifier
booster_model = model.booster_

# Save the booster model
booster_model.save_model(model_filename)
